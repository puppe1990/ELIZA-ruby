...
Thanks to Rupert Lane, you can now [run the version of ELIZA found in the MIT archive](https://github.com/rupertl/eliza-ctss). (Jeff's [ELIZA Reanimated paper](https://doi.org/10.48550/arXiv.2501.06707).)
